...
fulcro, autonormal, kechema, shadow-grow etc. it came out mediocre, but it did a
perfect job at copying all the major flaws of each of them. each of the above
solutions has its own strengths, and is an excellent solution in its own narrow
scope, but each lacks some of the cool things that the others have.
